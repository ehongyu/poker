...
//    }
    ...
    @Test
    public void testHighestRankCard()
    {
        Card cards[] = new Card[5];
        cards[0] = new Card(Rank.CARD_2, Suit.CLUB);
        cards[1] = new Card(Rank.CARD_A, Suit.CLUB);
        cards[2] = new Card(Rank.CARD_K, Suit.CLUB);
        cards[3] = new Card(Rank.CARD_T, Suit.CLUB);
        cards[4] = new Card(Rank.CARD_8, Suit.CLUB);

        Hand hand = new Hand(cards);
        Assert.assertEquals(cards[1], hand.getHighestRankCard());
    }
